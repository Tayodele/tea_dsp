...
def main():
  ...
  plistpath = scriptpath + "/resources/TeaFilter-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TeaFilter-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TeaFilter-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TeaFilter-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TeaFilter-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/TeaFilter.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/TeaFilter.iss",inplace=1):
